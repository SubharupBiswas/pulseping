      ...
      <nav className="sticky top-0 z-50 border-b border-zinc-200 dark:border-zinc-900/60 bg-white/75 dark:bg-[#030303]/60 backdrop-blur-xl transition-colors duration-250">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-x-8">
            ...
            <Link href="/terms" className="text-sm font-medium text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-200 transition duration-150">Terms</Link>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 relative z-10">
        ...
        <div className="mt-10 border border-zinc-200 dark:border-zinc-900/60 rounded-xl px-5 py-4 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)] bg-zinc-50/20 dark:bg-transparent transition-colors">
          <p className="text-sm text-zinc-500 dark:text-zinc-650">
            ...
            <a href="mailto:status@pulseping.io" className="text-zinc-700 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 transition duration-150">
              status@pulseping.io
            </a>{" "}
            or follow our{" "}
