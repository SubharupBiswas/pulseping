        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-zinc-650 dark:text-zinc-400 font-medium">
              ...
              <Link href="/sign-in" className="text-zinc-900 dark:text-zinc-100 font-semibold underline hover:text-emerald-500 transition duration-150">
                Sign in
              </Link>
            </span>
            <ThemeToggle />
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12 relative z-10">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-8">
            <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-zinc-950 dark:text-zinc-50 mb-2">Create your workspace</h1>
            <p className="text-sm text-zinc-500 dark:text-zinc-400">Get started with 5 free monitor streams.</p>
          </div>
