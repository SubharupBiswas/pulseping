...
var require_edge_instrumentation = __commonJS({
  ".next/server/edge-instrumentation.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[183], { 454: (a, b, c) => {
      "use strict";
      function d() {
      }
      ...
      var b = a(a.s = 454);
      (_ENTRIES = "u" < typeof _ENTRIES ? {} : _ENTRIES).middleware_instrumentation = b;
    }]);
  }
});
...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 6: (a, b, c) => {
      ...
      c.r(b), c.d(b, { default: () => kp, handler: () => ko });
      var o, p = {};
      async function q() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(p), c.d(p, { config: () => ki, default: () => kh });
      let r = null;
      async function s() {
...
${b11.message}`);
      ...
      })(["/", "/sign-in(.*)", "/sign-up(.*)", "/status(.*)", "/sitemap.xml", "/robots.txt", "/privacy", "/terms"]), kh = ((...a10) => {
        ...
        kg(b10) || await a10.protect();
      }), ki = { matcher: ["/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)", "/(api|trpc)(.*)"] };
      c(789);
      let kj = { ...p }, kk = "/src/middleware", kl = (0, kj.middleware || kj.default);
      class km extends Error {
        constructor(a10) {
          super(a10), this.stack = "";
        }
      }
      if ("function" != typeof kl) throw new km(`The Middleware file "${kk}" must export a function named \`middleware\` or a default function.`);
      let kn = (a10) => bo({ ...a10, IncrementalCache: b0, incrementalCacheHandler: null, page: kk, handler: async (...a11) => {
        try {
          return await kl(...a11);
        } catch (e10) {
      ...
      async function ko(a10, b10) {
        let c10 = await kn({ request: { url: a10.url, method: a10.method, headers: H(a10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: kk }, body: "GET" !== a10.method && "HEAD" !== a10.method ? a10.body ?? void 0 : void 0, waitUntil: b10.waitUntil, requestMeta: b10.requestMeta, signal: b10.signal || new AbortController().signal } });
...
var BuildId = "tcRCVQuhX9_88_YZ9BntZ";
