...
* **`GET /api/telemetry`**: Retrieves monitor latency history and uptime availability percentages filtered by tier log retention window (`logRetentionDays`).
...
Copyright (c) 2026 Subharup Biswas. All Rights Reserved.

This repository and its source code are publicly accessible for educational, portfolio inspection, and recruitment evaluation purposes only.

TERMS AND CONDITIONS:
1. PERMITTED USE: You are permitted to view, clone, and inspect this codebase locally strictly for educational learning, peer review, or job application/recruitment assessment.

2. RESTRICTIONS:
   - You MAY NOT host, deploy, run, or distribute this software (or any derivative work) as a public or private hosted service or SaaS.
   - You MAY NOT use, modify, or copy any portion of this codebase for commercial gain or within a commercial product.
   - You MAY NOT redistribute, sublicense, or sell this source code in part or in full.

For commercial licensing inquiries or explicit permissions, contact: [pulseping@subharup.com](mailto:pulseping@subharup.com)